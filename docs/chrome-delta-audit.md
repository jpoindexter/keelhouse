...
| Tray/dock nav | Tab strips: dock `Files/Editor/Browser/Git + ×` (38px), tray `Terminal/Processes/Logs` (34px), underline actives, collapsible | Tools popover + drawer modes; movable trays (KEEP); no duplicate Browser surface | Structural (hybrid) |
